...
{
    public class TriangularStrategy_USDT_ETH_BTC : Strategy, IStrategy
    {
        public TriangularStrategy_USDT_ETH_BTC()
        {
            StartBalanceCurrency1 = 30000;
            BalanceCurrency1 = 30000;
        }

        public string Name { get; private set; } = "Triangular strategy USDT_ETH_BTC";
        ...
        public Task Execute(string date)
        {
            ...
            BalanceCurrency1 = ((BalanceCurrency1 / CurrencyService.ETHUSDT) * CurrencyService.ETHBTC) * CurrencyService.BTCUSDT;
